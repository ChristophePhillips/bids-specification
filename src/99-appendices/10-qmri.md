...
| B1<sup>+</sup> mapping with 3D EPI            | TB1EPI   | RF Grouping | Groups images for B1<sup>+</sup> field mapping ([Jiru and Klose 2006](https://dx.doi.org/10.1002/mrm.21083), [Lutti et al. 2010](https://doi.org/10.1002/mrm.22421)). This method is based on two EPI readouts to acquire spin echo (SE) and stimulated echo (STE) images at multiple flip angles in one sequence, used in the calculation of deviations from the nominal flip angle. _Associated output suffixes_: `TB1map`                                                                                                                                                      |
...
However, the second echo in this method is generated in a different fashion compared to the MESE.  Whereas the first echo is a typical spin echo (SE) formed from the pulses alpha-2alpha, the second echo is a stimulated echo (STE), formed by an additional alpha pulse (i.e. alpha-2alpha-alpha).
